...
class AdminMapToSearchInEditUser extends StatefulWidget {
  Map<String, dynamic> map;

  AdminMapToSearchInEditUser({super.key, required this.map});

  @override
  _AdminMapToSearchInEditUserState createState() => _AdminMapToSearchInEditUserState();
}

class _AdminMapToSearchInEditUserState extends State<AdminMapToSearchInEditUser> {
  ...
  Future<void> _getCurrentLocation() async {
    try {
      ...
      if(widget.map['lat'].runtimeType == String) {
        _currentLocation = LatLng(double.parse(widget.map['lat']), double.parse(widget.map['lng']));
      } else {

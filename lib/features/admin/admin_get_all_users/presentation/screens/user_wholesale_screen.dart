...
class UserWholesaleScreen extends StatelessWidget {
  const UserWholesaleScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) =>
            GetAllUsersCubit()..getAllUsersFunction(role: 'user-wholesale'),

...
class GetAllOrdersInUserWholesaleInManager extends StatelessWidget {
  const GetAllOrdersInUserWholesaleInManager({Key? key}) : super(key: key);
      ...
      body: BlocProvider(
        ...
        child: BlocBuilder<AdminOrderCubit, AdminOrderState>(
          builder: (context, state) {
            ...
            return adminOrderCubit.getListOfOrdersInAdminAndInManager == null ||
              ...
              child: Column(
                ...
                children: [
                  ...
                  Lottie.asset('assets/lotties/empty.json', height: 120.h),
                ],
              ),
            )
                  ...
                  children: [
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        buttonText: order.status == 'in-progress'
                        ? AppLocalizations.of(context)!
                            .confirm
                            : AppLocalizations.of(context)!
                            .approved,
                        confirmColor: order.status == 'in-progress'
...
/*----------------------------------------------------*/
class GetAllOrdersInUserWholesaleInAdmin extends StatelessWidget {
  const GetAllOrdersInUserWholesaleInAdmin({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) =>
        AdminOrderCubit()
          ..getAllOrdersInAdminFunction(role: 'user-wholesale'),
        child: BlocBuilder<AdminOrderCubit, AdminOrderState>(
          builder: (context, state) {
            var adminOrderCubit = AdminOrderCubit.get(context);
